    ...
    return (
        <div className="sidebar">
            ...
            <ul className="nav flex-column parent">
                ...
                <ul className="nav flex-column child">
                    <li className={`nav-item ${router.asPath == "/organizer-dashboard/organizer-settings" ? "active" : ""}`}>
                        <IoSettingsOutline /> <Link href="/organizer-dashboard/organizer-settings" className="nav-link"><a>Organizer Settings</a></Link>
                    </li>
                    ...
                    <li className={`nav-item ${router.asPath == "/organizer-dashboard/view-events" ? "active" : ""}`}>
                        <RiCalendarEventLine /> <Link href="/organizer-dashboard/view-events" className="nav-link">View Events</Link>
                    </li>
